...
def show_rows(path: Path, table: str, limit: int) -> None:
    allowed = {"users", "training_sessions", "vision_results", "ai_reports", "punch_events", "force_hit_results", "feedback_goals"}
...
def export_csv(path: Path, output: Path) -> None:
    ...
    with connect(path) as db:
        for table in ("users", "training_sessions", "vision_results", "ai_reports", "punch_events", "force_hit_results", "feedback_goals"):
...
def main() -> None:
    ...
    show.add_argument("table", choices=["users", "training_sessions", "vision_results", "ai_reports", "punch_events", "force_hit_results", "feedback_goals"])
